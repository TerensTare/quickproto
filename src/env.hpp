...
struct scope final
{
    ...
    entt::dense_map<std::string_view, entt::entity, dual_hash, dual_cmp> funcs; // (name -> mem_state) mapping
    entt::dense_map<std::string_view, type const *, dual_hash, dual_cmp> types;
